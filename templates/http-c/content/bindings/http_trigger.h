...
typedef struct spin_postgres_3_0_0_postgres_error_t {
  uint8_t tag;
  union {
...
} spin_postgres_3_0_0_postgres_error_t;

#define SPIN_POSTGRES_3_0_0_POSTGRES_ERROR_CONNECTION_FAILED 0
#define SPIN_POSTGRES_3_0_0_POSTGRES_ERROR_BAD_PARAMETER 1
#define SPIN_POSTGRES_3_0_0_POSTGRES_ERROR_QUERY_FAILED 2
#define SPIN_POSTGRES_3_0_0_POSTGRES_ERROR_VALUE_CONVERSION_FAILED 3
#define SPIN_POSTGRES_3_0_0_POSTGRES_ERROR_OTHER 4

// Data types for a database column
typedef uint8_t spin_postgres_3_0_0_postgres_db_data_type_t;

#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_BOOLEAN 0
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_INT8 1
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_INT16 2
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_INT32 3
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_INT64 4
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_FLOATING32 5
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_FLOATING64 6
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_STR 7
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_BINARY 8
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_DATE 9
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_TIME 10
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_DATETIME 11
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_TIMESTAMP 12
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_DATA_TYPE_OTHER 13
...
typedef struct {
  ...
  uint8_t f1;
  uint8_t f2;
} http_trigger_tuple3_s32_u8_u8_t;
...
typedef struct {
  ...
  uint8_t f5;
  uint32_t f6;
} http_trigger_tuple7_s32_u8_u8_u8_u8_u8_u32_t;

// Database values
typedef struct spin_postgres_3_0_0_postgres_db_value_t {
  uint8_t tag;
  union {
    bool     boolean;
    int8_t     int8;
    ...
    http_trigger_tuple3_s32_u8_u8_t     date;
    http_trigger_tuple4_u8_u8_u8_u32_t     time;
    http_trigger_tuple7_s32_u8_u8_u8_u8_u8_u32_t     datetime;
    int64_t     timestamp;
  } val;
} spin_postgres_3_0_0_postgres_db_value_t;

#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_BOOLEAN 0
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_INT8 1
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_INT16 2
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_INT32 3
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_INT64 4
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_FLOATING32 5
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_FLOATING64 6
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_STR 7
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_BINARY 8
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_DATE 9
// (year, month, day)
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_TIME 10
...
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_DATETIME 11
// Unix timestamp (seconds since epoch)
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_TIMESTAMP 12
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_DB_NULL 13
#define SPIN_POSTGRES_3_0_0_POSTGRES_DB_VALUE_UNSUPPORTED 14

// Values used in parameterized queries
typedef struct spin_postgres_3_0_0_postgres_parameter_value_t {
  uint8_t tag;
  union {
    bool     boolean;
    int8_t     int8;
...
} spin_postgres_3_0_0_postgres_parameter_value_t;

#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_BOOLEAN 0
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_INT8 1
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_INT16 2
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_INT32 3
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_INT64 4
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_FLOATING32 5
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_FLOATING64 6
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_STR 7
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_BINARY 8
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_DATE 9
// (year, month, day)
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_TIME 10
// (hour, minute, second, nanosecond)
// Date-time types are always treated as UTC (without timezone info).
// The instant is represented as a (year, month, day, hour, minute, second, nanosecond) tuple.
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_DATETIME 11
// Unix timestamp (seconds since epoch)
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_TIMESTAMP 12
#define SPIN_POSTGRES_3_0_0_POSTGRES_PARAMETER_VALUE_DB_NULL 13

// A database column
typedef struct spin_postgres_3_0_0_postgres_column_t {
  http_trigger_string_t   name;
  spin_postgres_3_0_0_postgres_db_data_type_t   data_type;
} spin_postgres_3_0_0_postgres_column_t;

// A database row
typedef struct spin_postgres_3_0_0_postgres_row_t {
  spin_postgres_3_0_0_postgres_db_value_t   *ptr;
  size_t len;
} spin_postgres_3_0_0_postgres_row_t;

typedef struct {
  spin_postgres_3_0_0_postgres_column_t *ptr;
  size_t len;
} spin_postgres_3_0_0_postgres_list_column_t;

typedef struct {
  spin_postgres_3_0_0_postgres_row_t *ptr;
  size_t len;
} spin_postgres_3_0_0_postgres_list_row_t;

// A set of database rows
typedef struct spin_postgres_3_0_0_postgres_row_set_t {
  spin_postgres_3_0_0_postgres_list_column_t   columns;
  spin_postgres_3_0_0_postgres_list_row_t   rows;
} spin_postgres_3_0_0_postgres_row_set_t;

typedef struct spin_postgres_3_0_0_postgres_own_connection_t {
  int32_t __handle;
} spin_postgres_3_0_0_postgres_own_connection_t;

typedef struct spin_postgres_3_0_0_postgres_borrow_connection_t {
  int32_t __handle;
} spin_postgres_3_0_0_postgres_borrow_connection_t;

typedef struct {
  bool is_err;
  union {
    spin_postgres_3_0_0_postgres_own_connection_t ok;
    spin_postgres_3_0_0_postgres_error_t err;
  } val;
} spin_postgres_3_0_0_postgres_result_own_connection_error_t;

typedef struct {
  spin_postgres_3_0_0_postgres_parameter_value_t *ptr;
  size_t len;
} spin_postgres_3_0_0_postgres_list_parameter_value_t;

typedef struct {
  bool is_err;
  union {
    spin_postgres_3_0_0_postgres_row_set_t ok;
    spin_postgres_3_0_0_postgres_error_t err;
  } val;
} spin_postgres_3_0_0_postgres_result_row_set_error_t;
...
} spin_postgres_3_0_0_postgres_result_u64_error_t;
...
typedef struct spin_postgres_4_0_0_postgres_db_error_t {
  // Stringised version of the error. This is primarily to facilitate migration of older code.
  http_trigger_string_t   as_text;
  http_trigger_string_t   severity;
  http_trigger_string_t   code;
  http_trigger_string_t   message;
  http_trigger_option_string_t   detail;
  // Any error information provided by Postgres and not captured above.
  http_trigger_list_tuple2_string_string_t   extras;
} spin_postgres_4_0_0_postgres_db_error_t;

typedef struct spin_postgres_4_0_0_postgres_query_error_t {
  uint8_t tag;
  union {
    http_trigger_string_t     text;
    spin_postgres_4_0_0_postgres_db_error_t     db_error;
  } val;
} spin_postgres_4_0_0_postgres_query_error_t;

// An error occurred but we do not have structured info for it
#define SPIN_POSTGRES_4_0_0_POSTGRES_QUERY_ERROR_TEXT 0
// Postgres returned a structured database error
#define SPIN_POSTGRES_4_0_0_POSTGRES_QUERY_ERROR_DB_ERROR 1

// Errors related to interacting with a database.
typedef struct spin_postgres_4_0_0_postgres_error_t {
  uint8_t tag;
  union {
    http_trigger_string_t     connection_failed;
    http_trigger_string_t     bad_parameter;
    spin_postgres_4_0_0_postgres_query_error_t     query_failed;
    http_trigger_string_t     value_conversion_failed;
    http_trigger_string_t     other;
  } val;
} spin_postgres_4_0_0_postgres_error_t;

#define SPIN_POSTGRES_4_0_0_POSTGRES_ERROR_CONNECTION_FAILED 0
#define SPIN_POSTGRES_4_0_0_POSTGRES_ERROR_BAD_PARAMETER 1
#define SPIN_POSTGRES_4_0_0_POSTGRES_ERROR_QUERY_FAILED 2
#define SPIN_POSTGRES_4_0_0_POSTGRES_ERROR_VALUE_CONVERSION_FAILED 3
#define SPIN_POSTGRES_4_0_0_POSTGRES_ERROR_OTHER 4

// Data types for a database column
typedef struct spin_postgres_4_0_0_postgres_db_data_type_t {
  uint8_t tag;
  union {
    http_trigger_string_t     other;
  } val;
} spin_postgres_4_0_0_postgres_db_data_type_t;

#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_BOOLEAN 0
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_INT8 1
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_INT16 2
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_INT32 3
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_INT64 4
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_FLOATING32 5
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_FLOATING64 6
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_STR 7
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_BINARY 8
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_DATE 9
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_TIME 10
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_DATETIME 11
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_TIMESTAMP 12
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_UUID 13
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_JSONB 14
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_DECIMAL 15
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_RANGE_INT32 16
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_RANGE_INT64 17
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_RANGE_DECIMAL 18
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_ARRAY_INT32 19
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_ARRAY_INT64 20
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_ARRAY_DECIMAL 21
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_ARRAY_STR 22
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_INTERVAL 23
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_DATA_TYPE_OTHER 24

typedef struct spin_postgres_4_0_0_postgres_interval_t {
  int64_t   micros;
  int32_t   days;
  int32_t   months;
} spin_postgres_4_0_0_postgres_interval_t;

// A database column
typedef struct spin_postgres_4_0_0_postgres_column_t {
  http_trigger_string_t   name;
  spin_postgres_4_0_0_postgres_db_data_type_t   data_type;
} spin_postgres_4_0_0_postgres_column_t;

// For range types, indicates if each bound is inclusive or exclusive
typedef uint8_t spin_postgres_4_0_0_postgres_range_bound_kind_t;

#define SPIN_POSTGRES_4_0_0_POSTGRES_RANGE_BOUND_KIND_INCLUSIVE 0
#define SPIN_POSTGRES_4_0_0_POSTGRES_RANGE_BOUND_KIND_EXCLUSIVE 1

typedef struct {
  int32_t f0;
  spin_postgres_4_0_0_postgres_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_s32_range_bound_kind_t;

typedef struct {
  bool is_some;
  spin_postgres_4_0_0_postgres_tuple2_s32_range_bound_kind_t val;
} spin_postgres_4_0_0_postgres_option_tuple2_s32_range_bound_kind_t;

typedef struct {
  spin_postgres_4_0_0_postgres_option_tuple2_s32_range_bound_kind_t f0;
  spin_postgres_4_0_0_postgres_option_tuple2_s32_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_option_tuple2_s32_range_bound_kind_option_tuple2_s32_range_bound_kind_t;

typedef struct {
  int64_t f0;
  spin_postgres_4_0_0_postgres_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_s64_range_bound_kind_t;

typedef struct {
  bool is_some;
  spin_postgres_4_0_0_postgres_tuple2_s64_range_bound_kind_t val;
} spin_postgres_4_0_0_postgres_option_tuple2_s64_range_bound_kind_t;

typedef struct {
  spin_postgres_4_0_0_postgres_option_tuple2_s64_range_bound_kind_t f0;
  spin_postgres_4_0_0_postgres_option_tuple2_s64_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_option_tuple2_s64_range_bound_kind_option_tuple2_s64_range_bound_kind_t;

typedef struct {
  http_trigger_string_t f0;
  spin_postgres_4_0_0_postgres_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_string_range_bound_kind_t;

typedef struct {
  bool is_some;
  spin_postgres_4_0_0_postgres_tuple2_string_range_bound_kind_t val;
} spin_postgres_4_0_0_postgres_option_tuple2_string_range_bound_kind_t;

typedef struct {
  spin_postgres_4_0_0_postgres_option_tuple2_string_range_bound_kind_t f0;
  spin_postgres_4_0_0_postgres_option_tuple2_string_range_bound_kind_t f1;
} spin_postgres_4_0_0_postgres_tuple2_option_tuple2_string_range_bound_kind_option_tuple2_string_range_bound_kind_t;

typedef struct {
  bool is_some;
  int32_t val;
} http_trigger_option_s32_t;

typedef struct {
  http_trigger_option_s32_t *ptr;
  size_t len;
} http_trigger_list_option_s32_t;

typedef struct {
  bool is_some;
  int64_t val;
} http_trigger_option_s64_t;

typedef struct {
  http_trigger_option_s64_t *ptr;
  size_t len;
} http_trigger_list_option_s64_t;

typedef struct {
  http_trigger_option_string_t *ptr;
  size_t len;
} http_trigger_list_option_string_t;

// Database values
typedef struct spin_postgres_4_0_0_postgres_db_value_t {
  uint8_t tag;
  union {
    bool     boolean;
    int8_t     int8;
    ...
    http_trigger_tuple7_s32_u8_u8_u8_u8_u8_u32_t     datetime;
    int64_t     timestamp;
    http_trigger_string_t     uuid;
    http_trigger_list_u8_t     jsonb;
    http_trigger_string_t     decimal;
    spin_postgres_4_0_0_postgres_tuple2_option_tuple2_s32_range_bound_kind_option_tuple2_s32_range_bound_kind_t     range_int32;
    spin_postgres_4_0_0_postgres_tuple2_option_tuple2_s64_range_bound_kind_option_tuple2_s64_range_bound_kind_t     range_int64;
    spin_postgres_4_0_0_postgres_tuple2_option_tuple2_string_range_bound_kind_option_tuple2_string_range_bound_kind_t     range_decimal;
    http_trigger_list_option_s32_t     array_int32;
    http_trigger_list_option_s64_t     array_int64;
    http_trigger_list_option_string_t     array_decimal;
    http_trigger_list_option_string_t     array_str;
    spin_postgres_4_0_0_postgres_interval_t     interval;
    http_trigger_list_u8_t     unsupported;
  } val;
} spin_postgres_4_0_0_postgres_db_value_t;

#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_BOOLEAN 0
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_INT8 1
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_INT16 2
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_INT32 3
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_INT64 4
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_FLOATING32 5
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_FLOATING64 6
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_STR 7
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_BINARY 8
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_DATE 9
// (year, month, day)
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_TIME 10
// (hour, minute, second, nanosecond)
// Date-time types are always treated as UTC (without timezone info).
// The instant is represented as a (year, month, day, hour, minute, second, nanosecond) tuple.
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_DATETIME 11
// Unix timestamp (seconds since epoch)
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_TIMESTAMP 12
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_UUID 13
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_JSONB 14
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_DECIMAL 15
// I admit defeat. Base 10
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_RANGE_INT32 16
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_RANGE_INT64 17
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_RANGE_DECIMAL 18
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_ARRAY_INT32 19
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_ARRAY_INT64 20
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_ARRAY_DECIMAL 21
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_ARRAY_STR 22
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_INTERVAL 23
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_DB_NULL 24
#define SPIN_POSTGRES_4_0_0_POSTGRES_DB_VALUE_UNSUPPORTED 25

// Values used in parameterized queries
typedef struct spin_postgres_4_0_0_postgres_parameter_value_t {
  uint8_t tag;
  union {
    bool     boolean;
    int8_t     int8;
...
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_BOOLEAN 0
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_INT8 1
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_INT16 2
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_INT32 3
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_INT64 4
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_FLOATING32 5
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_FLOATING64 6
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_STR 7
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_BINARY 8
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_DATE 9
// (year, month, day)
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_TIME 10
// (hour, minute, second, nanosecond)
// Date-time types are always treated as UTC (without timezone info).
// The instant is represented as a (year, month, day, hour, minute, second, nanosecond) tuple.
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_DATETIME 11
// Unix timestamp (seconds since epoch)
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_TIMESTAMP 12
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_UUID 13
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_JSONB 14
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_DECIMAL 15
// base 10
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_RANGE_INT32 16
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_RANGE_INT64 17
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_RANGE_DECIMAL 18
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_ARRAY_INT32 19
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_ARRAY_INT64 20
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_ARRAY_DECIMAL 21
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_ARRAY_STR 22
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_INTERVAL 23
#define SPIN_POSTGRES_4_0_0_POSTGRES_PARAMETER_VALUE_DB_NULL 24

// A database row
typedef struct spin_postgres_4_0_0_postgres_row_t {
  spin_postgres_4_0_0_postgres_db_value_t   *ptr;
  size_t len;
} spin_postgres_4_0_0_postgres_row_t;

typedef struct {
  spin_postgres_4_0_0_postgres_column_t *ptr;
  size_t len;
} spin_postgres_4_0_0_postgres_list_column_t;

typedef struct {
  spin_postgres_4_0_0_postgres_row_t *ptr;
  size_t len;
} spin_postgres_4_0_0_postgres_list_row_t;

// A set of database rows
typedef struct spin_postgres_4_0_0_postgres_row_set_t {
  spin_postgres_4_0_0_postgres_list_column_t   columns;
  spin_postgres_4_0_0_postgres_list_row_t   rows;
} spin_postgres_4_0_0_postgres_row_set_t;

typedef struct spin_postgres_4_0_0_postgres_own_connection_t {
  int32_t __handle;
} spin_postgres_4_0_0_postgres_own_connection_t;

typedef struct spin_postgres_4_0_0_postgres_borrow_connection_t {
  int32_t __handle;
} spin_postgres_4_0_0_postgres_borrow_connection_t;

typedef struct {
  bool is_err;
  union {
    spin_postgres_4_0_0_postgres_own_connection_t ok;
    spin_postgres_4_0_0_postgres_error_t err;
  } val;
} spin_postgres_4_0_0_postgres_result_own_connection_error_t;

typedef struct {
  spin_postgres_4_0_0_postgres_parameter_value_t *ptr;
  size_t len;
} spin_postgres_4_0_0_postgres_list_parameter_value_t;

typedef struct {
  bool is_err;
  union {
    spin_postgres_4_0_0_postgres_row_set_t ok;
    spin_postgres_4_0_0_postgres_error_t err;
  } val;
} spin_postgres_4_0_0_postgres_result_row_set_error_t;
...
} spin_postgres_4_0_0_postgres_result_u64_error_t;

typedef struct spin_sqlite_sqlite_own_connection_t {
  int32_t __handle;
} spin_sqlite_sqlite_own_connection_t;

typedef struct spin_sqlite_sqlite_borrow_connection_t {
  int32_t __handle;
} spin_sqlite_sqlite_borrow_connection_t;

// The set of errors which may be raised by functions in this interface
typedef struct spin_sqlite_sqlite_error_t {
  uint8_t tag;
  union {
    http_trigger_string_t     io;
  } val;
} spin_sqlite_sqlite_error_t;

// The host does not recognize the database name requested.
#define SPIN_SQLITE_SQLITE_ERROR_NO_SUCH_DATABASE 0
// The requesting component does not have access to the specified database (which may or may not exist).
#define SPIN_SQLITE_SQLITE_ERROR_ACCESS_DENIED 1
// The provided connection is not valid
#define SPIN_SQLITE_SQLITE_ERROR_INVALID_CONNECTION 2
// The database has reached its capacity
#define SPIN_SQLITE_SQLITE_ERROR_DATABASE_FULL 3
// Some implementation-specific error has occurred (e.g. I/O)
#define SPIN_SQLITE_SQLITE_ERROR_IO 4

// A single column's result from a database query
typedef struct spin_sqlite_sqlite_value_t {
  uint8_t tag;
  union {
    int64_t     integer;
    double     real;
...
} spin_sqlite_sqlite_value_t;

#define SPIN_SQLITE_SQLITE_VALUE_INTEGER 0
#define SPIN_SQLITE_SQLITE_VALUE_REAL 1
#define SPIN_SQLITE_SQLITE_VALUE_TEXT 2
#define SPIN_SQLITE_SQLITE_VALUE_BLOB 3
#define SPIN_SQLITE_SQLITE_VALUE_NULL 4

typedef struct {
  spin_sqlite_sqlite_value_t *ptr;
  size_t len;
} spin_sqlite_sqlite_list_value_t;

// A set of values for each of the columns in a query-result
typedef struct spin_sqlite_sqlite_row_result_t {
  spin_sqlite_sqlite_list_value_t   values;
} spin_sqlite_sqlite_row_result_t;
...
typedef struct {
  spin_sqlite_sqlite_row_result_t *ptr;
  size_t len;
} spin_sqlite_sqlite_list_row_result_t;

// A result of a query
typedef struct spin_sqlite_sqlite_query_result_t {
  ...
  spin_sqlite_sqlite_list_row_result_t   rows;
} spin_sqlite_sqlite_query_result_t;

typedef struct {
  bool is_err;
  union {
    spin_sqlite_sqlite_own_connection_t ok;
    spin_sqlite_sqlite_error_t err;
  } val;
} spin_sqlite_sqlite_result_own_connection_error_t;

typedef struct {
  bool is_err;
  union {
    spin_sqlite_sqlite_query_result_t ok;
    spin_sqlite_sqlite_error_t err;
  } val;
} spin_sqlite_sqlite_result_query_result_error_t;
...
typedef struct wasi_config_store_error_t {
  uint8_t tag;
  union {
    http_trigger_string_t     upstream;
    http_trigger_string_t     io;
  } val;
...
typedef struct {
  bool is_err;
  union {
    http_trigger_option_string_t ok;
...
typedef struct {
  bool is_err;
  union {
    http_trigger_list_tuple2_string_string_t ok;
    wasi_config_store_error_t err;
  } val;
...
typedef struct wasi_keyvalue_store_error_t {
  uint8_t tag;
  union {
    http_trigger_string_t     other;
  } val;
} wasi_keyvalue_store_error_t;

// The host does not recognize the store identifier requested.
#define WASI_KEYVALUE_STORE_ERROR_NO_SUCH_STORE 0
// The requesting component does not have access to the specified store
// (which may or may not exist).
#define WASI_KEYVALUE_STORE_ERROR_ACCESS_DENIED 1
// Some implementation-specific error has occurred (e.g. I/O)
#define WASI_KEYVALUE_STORE_ERROR_OTHER 2

// A response to a `list-keys` operation.
typedef struct wasi_keyvalue_store_key_response_t {
  // The list of keys returned by the query.
  http_trigger_list_string_t   keys;
...
} wasi_keyvalue_store_key_response_t;

typedef struct wasi_keyvalue_store_own_bucket_t {
  int32_t __handle;
} wasi_keyvalue_store_own_bucket_t;

typedef struct wasi_keyvalue_store_borrow_bucket_t {
  int32_t __handle;
} wasi_keyvalue_store_borrow_bucket_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_store_own_bucket_t ok;
    wasi_keyvalue_store_error_t err;
  } val;
} wasi_keyvalue_store_result_own_bucket_error_t;
...
} wasi_keyvalue_store_result_option_list_u8_error_t;
...
} wasi_keyvalue_store_result_void_error_t;
...
} wasi_keyvalue_store_result_bool_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_store_key_response_t ok;
    wasi_keyvalue_store_error_t err;
  } val;
} wasi_keyvalue_store_result_key_response_error_t;

typedef wasi_keyvalue_store_error_t wasi_keyvalue_atomics_error_t;

typedef struct wasi_keyvalue_atomics_own_cas_t {
  int32_t __handle;
} wasi_keyvalue_atomics_own_cas_t;

typedef struct wasi_keyvalue_atomics_borrow_cas_t {
  int32_t __handle;
} wasi_keyvalue_atomics_borrow_cas_t;

// The error returned by a CAS operation
typedef struct wasi_keyvalue_atomics_cas_error_t {
  uint8_t tag;
  union {
    wasi_keyvalue_atomics_error_t     store_error;
    wasi_keyvalue_atomics_own_cas_t     cas_failed;
  } val;
} wasi_keyvalue_atomics_cas_error_t;

// A store error occurred when performing the operation
#define WASI_KEYVALUE_ATOMICS_CAS_ERROR_STORE_ERROR 0
...
#define WASI_KEYVALUE_ATOMICS_CAS_ERROR_CAS_FAILED 1

typedef wasi_keyvalue_store_borrow_bucket_t wasi_keyvalue_atomics_borrow_bucket_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_atomics_own_cas_t ok;
    wasi_keyvalue_atomics_error_t err;
  } val;
...
} wasi_keyvalue_atomics_result_option_list_u8_error_t;
...
} wasi_keyvalue_atomics_result_s64_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_atomics_cas_error_t err;
  } val;
} wasi_keyvalue_atomics_result_void_cas_error_t;

typedef wasi_keyvalue_store_error_t wasi_keyvalue_batch_error_t;

typedef wasi_keyvalue_store_borrow_bucket_t wasi_keyvalue_batch_borrow_bucket_t;

typedef struct {
  http_trigger_string_t f0;
  http_trigger_option_list_u8_t f1;
} http_trigger_tuple2_string_option_list_u8_t;

typedef struct {
  http_trigger_tuple2_string_option_list_u8_t *ptr;
  size_t len;
} http_trigger_list_tuple2_string_option_list_u8_t;

typedef struct {
  bool is_err;
  union {
    http_trigger_list_tuple2_string_option_list_u8_t ok;
    wasi_keyvalue_batch_error_t err;
  } val;
} wasi_keyvalue_batch_result_list_tuple2_string_option_list_u8_error_t;

typedef struct {
  http_trigger_string_t f0;
  http_trigger_list_u8_t f1;
} http_trigger_tuple2_string_list_u8_t;

typedef struct {
  http_trigger_tuple2_string_list_u8_t *ptr;
  size_t len;
} http_trigger_list_tuple2_string_list_u8_t;
...
} wasi_keyvalue_batch_result_void_error_t;
...
extern bool spin_postgres_3_0_0_postgres_static_connection_open(http_trigger_string_t *address, spin_postgres_3_0_0_postgres_own_connection_t *ret, spin_postgres_3_0_0_postgres_error_t *err);
// Query the database.
extern bool spin_postgres_3_0_0_postgres_method_connection_query(spin_postgres_3_0_0_postgres_borrow_connection_t self, http_trigger_string_t *statement, spin_postgres_3_0_0_postgres_list_parameter_value_t *params, spin_postgres_3_0_0_postgres_row_set_t *ret, spin_postgres_3_0_0_postgres_error_t *err);
// Execute command to the database.
extern bool spin_postgres_3_0_0_postgres_method_connection_execute(spin_postgres_3_0_0_postgres_borrow_connection_t self, http_trigger_string_t *statement, spin_postgres_3_0_0_postgres_list_parameter_value_t *params, uint64_t *ret, spin_postgres_3_0_0_postgres_error_t *err);

// Imported Functions from `spin:postgres/postgres@4.0.0`
// Open a connection to the Postgres instance at `address`.
extern bool spin_postgres_4_0_0_postgres_static_connection_open(http_trigger_string_t *address, spin_postgres_4_0_0_postgres_own_connection_t *ret, spin_postgres_4_0_0_postgres_error_t *err);
// Query the database.
extern bool spin_postgres_4_0_0_postgres_method_connection_query(spin_postgres_4_0_0_postgres_borrow_connection_t self, http_trigger_string_t *statement, spin_postgres_4_0_0_postgres_list_parameter_value_t *params, spin_postgres_4_0_0_postgres_row_set_t *ret, spin_postgres_4_0_0_postgres_error_t *err);
// Execute command to the database.
extern bool spin_postgres_4_0_0_postgres_method_connection_execute(spin_postgres_4_0_0_postgres_borrow_connection_t self, http_trigger_string_t *statement, spin_postgres_4_0_0_postgres_list_parameter_value_t *params, uint64_t *ret, spin_postgres_4_0_0_postgres_error_t *err);
...
extern bool spin_sqlite_sqlite_static_connection_open(http_trigger_string_t *database, spin_sqlite_sqlite_own_connection_t *ret, spin_sqlite_sqlite_error_t *err);
// Execute a statement returning back data if there is any
extern bool spin_sqlite_sqlite_method_connection_execute(spin_sqlite_sqlite_borrow_connection_t self, http_trigger_string_t *statement, spin_sqlite_sqlite_list_value_t *parameters, spin_sqlite_sqlite_query_result_t *ret, spin_sqlite_sqlite_error_t *err);
...
extern int64_t spin_sqlite_sqlite_method_connection_last_insert_rowid(spin_sqlite_sqlite_borrow_connection_t self);
...
extern uint64_t spin_sqlite_sqlite_method_connection_changes(spin_sqlite_sqlite_borrow_connection_t self);
...
extern bool wasi_config_store_get(http_trigger_string_t *key, http_trigger_option_string_t *ret, wasi_config_store_error_t *err);
// Gets a list of configuration key-value pairs of type `string`.
// 
// If an error occurs, an `Err(error)` is returned.
extern bool wasi_config_store_get_all(http_trigger_list_tuple2_string_string_t *ret, wasi_config_store_error_t *err);
...
extern bool wasi_keyvalue_store_open(http_trigger_string_t *identifier, wasi_keyvalue_store_own_bucket_t *ret, wasi_keyvalue_store_error_t *err);
// Get the value associated with the specified `key`
// 
...
extern bool wasi_keyvalue_store_method_bucket_get(wasi_keyvalue_store_borrow_bucket_t self, http_trigger_string_t *key, http_trigger_option_list_u8_t *ret, wasi_keyvalue_store_error_t *err);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern bool wasi_keyvalue_store_method_bucket_set(wasi_keyvalue_store_borrow_bucket_t self, http_trigger_string_t *key, http_trigger_list_u8_t *value, wasi_keyvalue_store_error_t *err);
// Delete the key-value pair associated with the key in the store.
// 
// If the key does not exist in the store, it does nothing.
// 
// If any other error occurs, it returns an `Err(error)`.
extern bool wasi_keyvalue_store_method_bucket_delete(wasi_keyvalue_store_borrow_bucket_t self, http_trigger_string_t *key, wasi_keyvalue_store_error_t *err);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern bool wasi_keyvalue_store_method_bucket_exists(wasi_keyvalue_store_borrow_bucket_t self, http_trigger_string_t *key, bool *ret, wasi_keyvalue_store_error_t *err);
...
extern bool wasi_keyvalue_store_method_bucket_list_keys(wasi_keyvalue_store_borrow_bucket_t self, http_trigger_string_t *maybe_cursor, wasi_keyvalue_store_key_response_t *ret, wasi_keyvalue_store_error_t *err);
...
extern bool wasi_keyvalue_atomics_static_cas_new(wasi_keyvalue_atomics_borrow_bucket_t bucket, http_trigger_string_t *key, wasi_keyvalue_atomics_own_cas_t *ret, wasi_keyvalue_atomics_error_t *err);
...
extern bool wasi_keyvalue_atomics_method_cas_current(wasi_keyvalue_atomics_borrow_cas_t self, http_trigger_option_list_u8_t *ret, wasi_keyvalue_atomics_error_t *err);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern bool wasi_keyvalue_atomics_increment(wasi_keyvalue_atomics_borrow_bucket_t bucket, http_trigger_string_t *key, int64_t delta, int64_t *ret, wasi_keyvalue_atomics_error_t *err);
// Perform the swap on a CAS operation. This consumes the CAS handle and returns an error if
// the CAS operation failed.
extern bool wasi_keyvalue_atomics_swap(wasi_keyvalue_atomics_own_cas_t cas, http_trigger_list_u8_t *value, wasi_keyvalue_atomics_cas_error_t *err);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern bool wasi_keyvalue_batch_get_many(wasi_keyvalue_batch_borrow_bucket_t bucket, http_trigger_list_string_t *keys, http_trigger_list_tuple2_string_option_list_u8_t *ret, wasi_keyvalue_batch_error_t *err);
...
extern bool wasi_keyvalue_batch_set_many(wasi_keyvalue_batch_borrow_bucket_t bucket, http_trigger_list_tuple2_string_list_u8_t *key_values, wasi_keyvalue_batch_error_t *err);
...
// 
// Other concurrent operations may also be able to see the partial results.
extern bool wasi_keyvalue_batch_delete_many(wasi_keyvalue_batch_borrow_bucket_t bucket, http_trigger_list_string_t *keys, wasi_keyvalue_batch_error_t *err);
...
extern void spin_postgres_3_0_0_postgres_connection_drop_own(spin_postgres_3_0_0_postgres_own_connection_t handle);

extern void spin_postgres_3_0_0_postgres_connection_drop_borrow(spin_postgres_3_0_0_postgres_borrow_connection_t handle);

extern spin_postgres_3_0_0_postgres_borrow_connection_t spin_postgres_3_0_0_postgres_borrow_connection(spin_postgres_3_0_0_postgres_own_connection_t handle);
...
extern void spin_postgres_4_0_0_postgres_connection_drop_own(spin_postgres_4_0_0_postgres_own_connection_t handle);

extern void spin_postgres_4_0_0_postgres_connection_drop_borrow(spin_postgres_4_0_0_postgres_borrow_connection_t handle);

extern spin_postgres_4_0_0_postgres_borrow_connection_t spin_postgres_4_0_0_postgres_borrow_connection(spin_postgres_4_0_0_postgres_own_connection_t handle);
...
extern void spin_sqlite_sqlite_connection_drop_own(spin_sqlite_sqlite_own_connection_t handle);

extern void spin_sqlite_sqlite_connection_drop_borrow(spin_sqlite_sqlite_borrow_connection_t handle);

extern spin_sqlite_sqlite_borrow_connection_t spin_sqlite_sqlite_borrow_connection(spin_sqlite_sqlite_own_connection_t handle);
...
extern void wasi_io_0_2_0_poll_pollable_drop_borrow(wasi_io_0_2_0_poll_borrow_pollable_t handle);
...
extern void wasi_io_0_2_0_error_error_drop_borrow(wasi_io_0_2_0_error_borrow_error_t handle);
...
extern void wasi_io_0_2_0_streams_input_stream_drop_borrow(wasi_io_0_2_0_streams_borrow_input_stream_t handle);
...
extern void wasi_io_0_2_0_streams_output_stream_drop_borrow(wasi_io_0_2_0_streams_borrow_output_stream_t handle);
...
extern void wasi_http_0_2_0_types_fields_drop_borrow(wasi_http_0_2_0_types_borrow_fields_t handle);
...
extern void wasi_http_0_2_0_types_incoming_request_drop_borrow(wasi_http_0_2_0_types_borrow_incoming_request_t handle);
...
extern void wasi_http_0_2_0_types_outgoing_request_drop_borrow(wasi_http_0_2_0_types_borrow_outgoing_request_t handle);
...
extern void wasi_http_0_2_0_types_request_options_drop_borrow(wasi_http_0_2_0_types_borrow_request_options_t handle);
...
extern void wasi_http_0_2_0_types_response_outparam_drop_borrow(wasi_http_0_2_0_types_borrow_response_outparam_t handle);
...
extern void wasi_http_0_2_0_types_incoming_response_drop_borrow(wasi_http_0_2_0_types_borrow_incoming_response_t handle);
...
extern void wasi_http_0_2_0_types_incoming_body_drop_borrow(wasi_http_0_2_0_types_borrow_incoming_body_t handle);
...
extern void wasi_http_0_2_0_types_future_trailers_drop_borrow(wasi_http_0_2_0_types_borrow_future_trailers_t handle);
...
extern void wasi_http_0_2_0_types_outgoing_response_drop_borrow(wasi_http_0_2_0_types_borrow_outgoing_response_t handle);
...
extern void wasi_http_0_2_0_types_outgoing_body_drop_borrow(wasi_http_0_2_0_types_borrow_outgoing_body_t handle);
...
extern void wasi_http_0_2_0_types_future_incoming_response_drop_borrow(wasi_http_0_2_0_types_borrow_future_incoming_response_t handle);
...
extern void fermyon_spin_2_0_0_redis_connection_drop_borrow(fermyon_spin_2_0_0_redis_borrow_connection_t handle);
...
extern void fermyon_spin_2_0_0_mqtt_connection_drop_borrow(fermyon_spin_2_0_0_mqtt_borrow_connection_t handle);
...
extern void fermyon_spin_2_0_0_postgres_connection_drop_borrow(fermyon_spin_2_0_0_postgres_borrow_connection_t handle);
...
extern void fermyon_spin_2_0_0_mysql_connection_drop_borrow(fermyon_spin_2_0_0_mysql_borrow_connection_t handle);
...
extern void fermyon_spin_2_0_0_sqlite_connection_drop_borrow(fermyon_spin_2_0_0_sqlite_borrow_connection_t handle);
...
extern void fermyon_spin_2_0_0_key_value_store_drop_borrow(fermyon_spin_2_0_0_key_value_borrow_store_t handle);
...
extern void wasi_cli_0_2_0_terminal_input_terminal_input_drop_borrow(wasi_cli_0_2_0_terminal_input_borrow_terminal_input_t handle);
...
extern void wasi_cli_0_2_0_terminal_output_terminal_output_drop_borrow(wasi_cli_0_2_0_terminal_output_borrow_terminal_output_t handle);
...
extern void wasi_filesystem_0_2_0_types_descriptor_drop_borrow(wasi_filesystem_0_2_0_types_borrow_descriptor_t handle);
...
extern void wasi_filesystem_0_2_0_types_directory_entry_stream_drop_borrow(wasi_filesystem_0_2_0_types_borrow_directory_entry_stream_t handle);
...
extern void wasi_sockets_0_2_0_network_network_drop_borrow(wasi_sockets_0_2_0_network_borrow_network_t handle);
...
extern void wasi_sockets_0_2_0_udp_udp_socket_drop_borrow(wasi_sockets_0_2_0_udp_borrow_udp_socket_t handle);
...
extern void wasi_sockets_0_2_0_udp_incoming_datagram_stream_drop_borrow(wasi_sockets_0_2_0_udp_borrow_incoming_datagram_stream_t handle);
...
extern void wasi_sockets_0_2_0_udp_outgoing_datagram_stream_drop_borrow(wasi_sockets_0_2_0_udp_borrow_outgoing_datagram_stream_t handle);
...
extern void wasi_sockets_0_2_0_tcp_tcp_socket_drop_borrow(wasi_sockets_0_2_0_tcp_borrow_tcp_socket_t handle);
...
extern void wasi_sockets_0_2_0_ip_name_lookup_resolve_address_stream_drop_borrow(wasi_sockets_0_2_0_ip_name_lookup_borrow_resolve_address_stream_t handle);
...
extern void wasi_keyvalue_store_bucket_drop_own(wasi_keyvalue_store_own_bucket_t handle);

extern void wasi_keyvalue_store_bucket_drop_borrow(wasi_keyvalue_store_borrow_bucket_t handle);

extern wasi_keyvalue_store_borrow_bucket_t wasi_keyvalue_store_borrow_bucket(wasi_keyvalue_store_own_bucket_t handle);
...
extern void wasi_keyvalue_atomics_cas_drop_own(wasi_keyvalue_atomics_own_cas_t handle);

extern void wasi_keyvalue_atomics_cas_drop_borrow(wasi_keyvalue_atomics_borrow_cas_t handle);

extern wasi_keyvalue_atomics_borrow_cas_t wasi_keyvalue_atomics_borrow_cas(wasi_keyvalue_atomics_own_cas_t handle);
